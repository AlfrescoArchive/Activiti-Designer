...
public class KickstartProcessNotificationService implements INotificationService {

  private final IDiagramTypeProvider diagramTypeProvider;

  public KickstartProcessNotificationService(final IDiagramTypeProvider diagramTypeProvider) {
    super();
