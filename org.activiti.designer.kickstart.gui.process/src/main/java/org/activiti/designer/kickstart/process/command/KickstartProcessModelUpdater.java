...
/**
 * Class capable of updating and cloning a Kickstart process model object.
 * 
 * Calls the necessary methods to notify the {@link KickstartProcessMemoryModel} of the change
 * and optional notifies the Diagram UI.
 * 
 * @author Tijs Rademakers
 */
public abstract class KickstartProcessModelUpdater<T extends Object> {
   ...
   */
  public KickstartProcessModelUpdater(T businessObject, PictogramElement pictogramElement, IFeatureProvider featureProvider) {
