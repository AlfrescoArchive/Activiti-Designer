 ...
 * {@link ReferencePropertyDefinition} objects, which represent a due-date.
 *  
 * @author Frederik Heremans
 */
public class DueDatePropertyShapeController extends SimpleIconInputShapeController {
  
  public DueDatePropertyShapeController(KickstartFormFeatureProvider featureProvider) {
    super(featureProvider);
  }

  @Override
  public boolean canControlShapeFor(Object businessObject) {
    return businessObject instanceof ReferencePropertyDefinition && AlfrescoConversionConstants.FORM_REFERENCE_DUEDATE.equals(
