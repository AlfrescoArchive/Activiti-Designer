 ...
 * {@link ReferencePropertyDefinition} objects, which represent the email notification checkbox.
 *  
 * @author Frederik Heremans
 */
public class EmailNotificationPropertyShapeController extends SimpleIconInputShapeController {
  
  public EmailNotificationPropertyShapeController(KickstartFormFeatureProvider featureProvider) {
    super(featureProvider);
  }

  @Override
  public boolean canControlShapeFor(Object businessObject) {
    return businessObject instanceof ReferencePropertyDefinition && AlfrescoConversionConstants.FORM_REFERENCE_EMAIL_NOTIFICATION.equals(
