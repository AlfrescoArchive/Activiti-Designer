...
public class AddEventGatewayFeature extends AbstractAddShapeFeature {

  private static final int IMAGE_SIZE = 20;
  
	public AddEventGatewayFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public PictogramElement add(IAddContext context) {
      ...
      final Image image = gaService.createImage(shape, ActivitiImageProvider.IMG_GATEWAY_EVENT);
