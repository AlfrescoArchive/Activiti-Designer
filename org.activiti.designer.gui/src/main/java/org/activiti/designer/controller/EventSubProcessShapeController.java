...
public class EventSubProcessShapeController extends AbstractBusinessObjectShapeController {
  ...
  public EventSubProcessShapeController(ActivitiBPMNFeatureProvider featureProvider) {
    super(featureProvider);
  }

  @Override
  public boolean canControlShapeFor(Object businessObject) {
    if (businessObject instanceof EventSubProcess) {
      return true;
    } else {
      return false;
    }
  ...
  public PictogramElement createShape(Object businessObject, ContainerShape layoutParent, int width, int height, IAddContext context) {
    ...
    roundedRectangle.setBackground(gaService.manageColor(diagram, IColorConstant.WHITE));
  ...
  public void updateShape(PictogramElement element, Object businessObject, int width, int height) {
    ...
    if (labelText != null) {
      labelText.setValue(getLabelTextValue(subProcess));
    }
  }
  ...
  public boolean isShapeUpdateNeeded(PictogramElement element, Object businessObject) {
    ...
    String newLabel = getLabelTextValue(subProcess);
