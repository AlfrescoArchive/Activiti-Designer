 ...
 * @version 1
 */
public class CustomPropertyTextField extends AbstractCustomPropertyField {

  private Text textControl;

  public CustomPropertyTextField(final PropertyCustomServiceTaskSection section, final ServiceTask serviceTask, final Field field) {
  ...
  public Composite render(final Composite parent, final TabbedPropertySheetWidgetFactory factory, final FocusListener listener) {
    ...
    textControl = factory.createText(result, "", SWT.BORDER_SOLID);
