...
public class MessageDialog extends Dialog implements ITabbedPropertyConstants {
	...
	public MessageDialog(Shell parent, TableItem[] fieldList) {
		// Pass the default styles here
		this(parent, fieldList, SWT.DIALOG_TRIM | SWT.APPLICATION_MODAL);
	}
	
	public MessageDialog(Shell parent, TableItem[] fieldList, String savedId, String savedName) {
    // Pass the default styles here
    this(parent, fieldList, SWT.DIALOG_TRIM | SWT.APPLICATION_MODAL);
	...
	public MessageDialog(Shell parent, TableItem[] fieldList, int style) {
		// Let users override the default styles
		super(parent, style);
		setText("Message configuration");
	}
		...
		ok.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent event) {
				...
				if(StringUtils.isEmpty(nameText.getText())) {
				  org.eclipse.jface.dialogs.MessageDialog.openError(shell, "Validation error", "Name must be filled.");
          return;
        }
				id = idText.getText();
