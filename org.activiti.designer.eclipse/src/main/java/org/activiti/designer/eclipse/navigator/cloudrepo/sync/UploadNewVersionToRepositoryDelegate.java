 ...
 */
public class UploadNewVersionToRepositoryDelegate implements IObjectActionDelegate {
		...
		try {
		  ...
		  if (definitionAttributeMap.containsKey("modelId")) {
			...
			if (modelId == null || modelId.length() == 0) {
			  SyncUtil.startImportModelBackgroundJob(shell, selectedFile.getName(), selectedFile);
				
			} else {
				
				SyncUtil.startUploadNewVersionBackgroundJob(shell, modelId, selectedFile.getName(), selectedFile);
